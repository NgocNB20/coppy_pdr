...
public class PageInfoHelper {
     ...
     * @param pageResponse ページ情報レスポンス
     */
    public <T extends AbstractConditionDto> void setupResponsePager(PageInfo pageInfo, Object pageResponse, int num)
                    throws InvocationTargetException, IllegalAccessException {
        // Pagerセットアップ
        pageInfo.setupViewPager(num);
     ...
     * @return pageInfo
     */
    public PageInfo setupPageInfo(String pnum, int limit, boolean skipCountFlg, String sort) {
        // ----------------------------
        // PageInfo生成
        // ----------------------------
        PageInfo pageInfo = ApplicationContextUtility.getBean(PageInfo.class);
