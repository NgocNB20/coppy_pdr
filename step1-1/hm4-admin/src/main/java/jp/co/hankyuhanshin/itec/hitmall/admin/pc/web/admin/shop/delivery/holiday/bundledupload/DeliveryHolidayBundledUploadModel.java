...
public class DeliveryHolidayBundledUploadModel extends AbstractModel {
    ...
    @HVCsvHeader(csvDtoClass = HolidayCsvDto.class)
     ...
     * エラーリスト
     */
    private List<DeliveryHolidayBundledUploadFinishModelItem> resultItems;
