...
@Component
@Data
public abstract class AbstractCommonProcessLogic extends AbstractShopLogic {
    ...
    protected String createAccessUid() {
        ...
        // 端末識別番号作成
        AccessUidCreateLogic accessUidCreateLogic = getComponent(AccessUidCreateLogic.class);
        return accessUidCreateLogic.execute();
    }
    ...
    protected String getAccessUid(HttpServletRequest request) {
        ...
        if (cookie != null) {
            try {
                ...
                // 復号
                CryptoHelper cryptoHelper = getComponent(CryptoHelper.class);
