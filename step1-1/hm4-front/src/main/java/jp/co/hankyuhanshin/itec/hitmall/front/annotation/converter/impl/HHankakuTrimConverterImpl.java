...
/**
 * <span class="logicName">【データ両端の空白・半角変換】</span>データの先頭／末尾のスペースを除去し、半角変換するコンバータのアノテーションlogic実装クラス<br/>
 *
 * @author kamei
 */
public class HHankakuTrimConverterImpl implements Formatter<String> {
    ...
    public String parse(String fromScreen, Locale locale) throws ParseException {
        ...
        return zenHanConversionUtility.toHankaku(fromScreen).trim();
    }
}
