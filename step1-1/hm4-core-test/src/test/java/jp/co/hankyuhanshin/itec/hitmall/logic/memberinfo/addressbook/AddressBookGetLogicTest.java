...
public class AddressBookGetLogicTest {

    @Autowired
    AddressBookGetLogic logic;
    ...
    public void executeTest() {
        ...
        Integer addressBookSeq = 2;
        AddressBookEntity entity = new AddressBookEntity();

        // モック設定
        doReturn(entity).when(dao).getEntity(any(Integer.class), any(Integer.class));

        // 試験実行
        AddressBookEntity actual = logic.execute(memberInfoSeq, addressBookSeq);
