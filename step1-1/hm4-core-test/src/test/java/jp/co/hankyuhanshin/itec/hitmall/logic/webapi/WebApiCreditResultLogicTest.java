...
public class WebApiCreditResultLogicTest {
    @Autowired
    WebApiCreditResultLogic webApiCreditResultLogic;
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiCreditResultResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiCreditResultLogic.execute(requestDto);
