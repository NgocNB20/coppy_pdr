...
public class OpenCategoryListGetServiceTest {

    @Autowired
    OpenCategoryListGetService service;

    @MockBean
    private CategoryDetailsListGetLogic logic;
    ...
    public void executeTest() {
        ...
        // 試験実行
        List<CategoryDetailsDto> actual = service.execute(categorySeqList);
