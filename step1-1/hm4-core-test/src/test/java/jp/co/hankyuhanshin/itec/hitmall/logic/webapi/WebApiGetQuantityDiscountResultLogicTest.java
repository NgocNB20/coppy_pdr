...
public class WebApiGetQuantityDiscountResultLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetQuantityDiscountResultResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetQuantityDiscountResultLogic.execute(requestDto);
