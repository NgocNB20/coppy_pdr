...
public class SettlementMethodUpdateLogicTest {
    ...
    public void execute() {
        ...
        doReturn(1).when(settlementMethodDao).update((SettlementMethodEntity) any(Object.class));

        int temp = settlementMethodUpdateLogic.execute(entity);

        verify(settlementMethodDao, times(1)).update((SettlementMethodEntity) any(Object.class));
