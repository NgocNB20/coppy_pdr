...
public class WebApiGetOrderDetailInformationLogicTest {
    @Autowired
    WebApiGetOrderDetailInformationLogic webApiGetOrderDetailInformationLogic;
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetOrderDetailInformationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetOrderDetailInformationLogic.execute(requestDto);
