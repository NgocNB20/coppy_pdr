...
public class WebApiGetNotYetShippingOrderHistoryLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetNotYetShippingOrderHistoryResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetNotYetShippingOrderHistoryLogic.execute(requestDto);
