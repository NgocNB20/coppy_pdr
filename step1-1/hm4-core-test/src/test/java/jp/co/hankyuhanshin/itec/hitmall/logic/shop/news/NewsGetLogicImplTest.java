...
public class NewsGetLogicImplTest {
    ...
    public void executeTest() {
        ...
        // モック設定
        doReturn(result).when(dao).getEntityByShopSeq(entity.getNewsSeq(), entity.getShopSeq());

        // 試験実行
        NewsEntity actual = logic.execute(entity.getNewsSeq(), entity.getShopSeq());

        // 戻り値及び呼び出し検証
        verify(dao, times(1)).getEntityByShopSeq(entity.getNewsSeq(), entity.getShopSeq());
