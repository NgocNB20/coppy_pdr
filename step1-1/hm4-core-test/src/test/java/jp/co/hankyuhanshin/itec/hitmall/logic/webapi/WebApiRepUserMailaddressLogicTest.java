...
public class WebApiRepUserMailaddressLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiRepUserMailaddressResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiRepUserMailaddressLogic.execute(requestDto);
