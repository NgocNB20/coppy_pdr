...
/**
 * Logic/Service移行：関連商品リスト取得（バック用）
 * 作成日：2021/03/23
 *
...
public class GoodsRelationListGetForBackServiceTest {

    @Autowired
    GoodsRelationListGetForBackService service;

    @MockBean
    private GoodsRelationListGetForBackLogic logic;
    ...
    public void executeTest() {
        ...
        // 試験実行
        List<GoodsRelationEntity> actual = service.execute(goodsGroupSeq);
