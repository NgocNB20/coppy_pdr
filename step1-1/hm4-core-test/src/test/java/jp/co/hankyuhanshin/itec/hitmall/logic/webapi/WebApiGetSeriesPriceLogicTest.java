...
public class WebApiGetSeriesPriceLogicTest {
    @Autowired
    WebApiGetSeriesPriceLogic webApiGetSeriesPriceLogic;
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetSeriesPriceResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetSeriesPriceLogic.execute(requestDto);
