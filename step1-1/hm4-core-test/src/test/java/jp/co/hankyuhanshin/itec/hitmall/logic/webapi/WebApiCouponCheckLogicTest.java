...
public class WebApiCouponCheckLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiCouponCheckResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiCouponCheckLogic.execute(requestDto);
