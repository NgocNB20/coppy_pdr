...
public class DeliverySpecialChargeAreaCountGetLogicTest {
    ...
    public void execute() {
        ...
        // モック設定
        doReturn(result).when(deliverySpecialChargeAreaDao).getCount(any(Integer.class));

        // 試験実行
        int actual = deliverySpecialChargeAreaCountGetLogic.execute(1);

        // 戻り値及び呼び出し検証
        verify(deliverySpecialChargeAreaDao, times(1)).getCount(any(Integer.class));
