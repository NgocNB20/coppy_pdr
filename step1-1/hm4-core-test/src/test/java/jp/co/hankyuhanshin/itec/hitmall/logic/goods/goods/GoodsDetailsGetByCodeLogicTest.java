...
public class GoodsDetailsGetByCodeLogicTest {
    ...
    @Order(1)
    public void execute() {
        GoodsDetailsDto goodsDetailsDto = goodsDetailsGetByCodeLogic.execute(999, "999", HTypeSiteType.FRONT_PC,
                                                                             HTypeOpenDeleteStatus.OPEN
                                                                            );
        Assertions.assertNull(goodsDetailsDto);
    }
}
