...
public class WebApiGetPromotionInformationLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetPromotionInformationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetPromotionInformationLogic.execute(requestDto);
