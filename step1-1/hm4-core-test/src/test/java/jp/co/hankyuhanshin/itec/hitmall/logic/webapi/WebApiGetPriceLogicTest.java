...
public class WebApiGetPriceLogicTest {

    @Autowired
    WebApiGetPriceLogic webApiGetPriceLogic;
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetPriceResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetPriceLogic.execute(requestDto);
