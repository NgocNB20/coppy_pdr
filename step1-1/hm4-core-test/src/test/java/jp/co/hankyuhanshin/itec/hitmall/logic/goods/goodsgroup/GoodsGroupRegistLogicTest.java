...
public class GoodsGroupRegistLogicTest {
    ...
    public void execute() {
        ...
        doReturn(1).when(goodsGroupDao).insert(any(GoodsGroupEntity.class));
        int result = goodsGroupRegistLogic.execute(goodsGroupEntity);

        verify(goodsGroupDao, times(1)).insert(any(GoodsGroupEntity.class));
