...
public class WebApiAddUserInformationLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiAddUserInformationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiAddUserInformationLogic.execute(requestDto);
