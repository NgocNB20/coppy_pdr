...
public class WebApiDelDestinationLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiDelDestinationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiDelDestinationLogic.execute(requestDto);
