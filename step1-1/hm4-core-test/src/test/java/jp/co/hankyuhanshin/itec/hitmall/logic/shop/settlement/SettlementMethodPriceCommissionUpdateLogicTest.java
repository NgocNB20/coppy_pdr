...
public class SettlementMethodPriceCommissionUpdateLogicTest {
    ...
    public void execute() {
        ...
        doReturn(1).when(settlementMethodPriceCommissionDao)
                   .update((SettlementMethodPriceCommissionEntity) any(Object.class));

        int temp = settlementMethodPriceCommissionUpdateLogic.execute(entity);

        verify(settlementMethodPriceCommissionDao, times(1)).update(
