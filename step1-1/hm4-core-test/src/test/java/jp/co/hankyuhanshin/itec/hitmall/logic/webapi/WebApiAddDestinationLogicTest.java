...
public class WebApiAddDestinationLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiAddDestinationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiAddDestinationLogic.execute(requestDto);
