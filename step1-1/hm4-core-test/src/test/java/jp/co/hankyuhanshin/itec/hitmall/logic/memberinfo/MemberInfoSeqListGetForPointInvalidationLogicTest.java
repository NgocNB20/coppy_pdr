...
public class MemberInfoSeqListGetForPointInvalidationLogicTest {

    @Autowired
    MemberInfoSeqListGetForPointInvalidationLogic memberInfoSeqListGetForPointInvalidationLogic;
    ...
    public void execute() {
        ...
        List<Integer> result = memberInfoSeqListGetForPointInvalidationLogic.execute();
