...
public class OrderSearchOrderListGetServiceTest {

    @Autowired
    OrderSearchOrderListGetService service;
    ...
    public void executeTest() {
        ...
        // モック設定
        doReturn(result).when(logic).execute(any(OrderSearchConditionDto.class));

        // 試験実行
        List<OrderSearchOrderResultDto> actual = service.execute(conditionDto);
