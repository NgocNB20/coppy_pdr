...
public class SecureOrderRegisterLogicTest {

    @Autowired
    SecureOrderRegisterLogic secureOrderRegisterLogic;
    ...
    public void execute() {
        ...
        doReturn(listOrderGoodsEntity).when(orderGoodsDao).getOrderGoodsList(any(Integer.class), any(Integer.class));

        // 試験実行
        secureOrderRegisterLogic.execute(receiveOrderDto);
        ...
        verify(orderGoodsDao, times(1)).getOrderGoodsList(any(Integer.class), any(Integer.class));
    }
}
