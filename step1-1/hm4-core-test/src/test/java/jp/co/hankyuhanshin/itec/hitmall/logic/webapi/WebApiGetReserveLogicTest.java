...
public class WebApiGetReserveLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetReserveResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetReserveLogic.execute(requestDto);
