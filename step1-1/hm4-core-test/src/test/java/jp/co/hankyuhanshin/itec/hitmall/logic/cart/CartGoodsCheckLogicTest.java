...
public class CartGoodsCheckLogicTest {

    @Autowired
    CartGoodsCheckLogic cartGoodsCheckLogic;
    ...
    public void executeTest() {
        ...
        goodsDetailsDto.setGoodsClassType(HTypeGoodsClassType.DRUG_HUMAN);
        ...
        goodsDetailsDto.setSaleYesNo(1);
        ...
        Map<Integer, List<CheckMessageDto>> errorMessageMap =
                        cartGoodsCheckLogic.execute(cartDto, HTypeSiteType.FRONT_PC);

        // checkOpenStatusでエラーが発生
        Assertions.assertEquals(errorMessageMap.size(), 1);
    }

    @Test
    @Order(1)
    public void executeTestCartGoodsDtoListNull() {
        CartGoodsEntity cartGoodsEntity = new CartGoodsEntity();
        cartGoodsEntity.setCartSeq(0);
        cartGoodsEntity.setAccessUid("");
        cartGoodsEntity.setMemberInfoSeq(0);
        ...
        cartDto.setGoodsTotalPrice(new BigDecimal("0"));
        cartDto.setGoodsTotalPriceInTax(new BigDecimal("0"));
        cartDto.setCartGoodsDtoList(null);
        cartDto.setSettlementMethodType(HTypeSettlementMethodType.AMAZON_PAYMENT);
        ...
        // checkOpenStatusでエラーが発生
        Assertions.assertEquals(errorMessageMap.size(), 0);
    }
}
