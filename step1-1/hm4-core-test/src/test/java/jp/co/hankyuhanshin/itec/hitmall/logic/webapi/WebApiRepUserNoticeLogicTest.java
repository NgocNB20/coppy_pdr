...
public class WebApiRepUserNoticeLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiRepUserNoticeResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiRepUserNoticeLogic.execute(requestDto);
