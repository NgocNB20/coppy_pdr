...
public class CartGoodsCountUpdateLogicTest {

    @Autowired
    CartGoodsCountUpdateLogic cartGoodsCountUpdateLogic;
    ...
    public void executeTest() {
        ...
        int totalUpdateCount = cartGoodsCountUpdateLogic.execute(cartGoodsDtoList, 1, "");
        ...
        // goodsseq: 1
        // cartgoodscount: 1
        Assertions.assertEquals(totalUpdateCount, 1);
    }
}
