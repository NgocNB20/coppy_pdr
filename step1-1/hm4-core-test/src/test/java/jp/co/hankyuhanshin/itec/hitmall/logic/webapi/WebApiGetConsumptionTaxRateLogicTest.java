...
public class WebApiGetConsumptionTaxRateLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetConsumptionTaxRateResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetConsumptionTaxRateLogic.execute(requestDto);
