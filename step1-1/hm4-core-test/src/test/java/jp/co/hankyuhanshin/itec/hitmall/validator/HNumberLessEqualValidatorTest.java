...
public class HNumberLessEqualValidatorTest {

    private Validator validator;

    // デフォルトコンストラクタ
    public HNumberLessEqualValidatorTest() {
    ...
    public void test2() {
        ...
        result.forEach(r -> Assertions.assertEquals(r.getMessage(), "{HNumberLessEqualValidator.LESS_EQUAL_detail}"));
    }
     ...
     */
    @Data
    @HVRNumberLessEqual(target = "value", comparison = "value1")
