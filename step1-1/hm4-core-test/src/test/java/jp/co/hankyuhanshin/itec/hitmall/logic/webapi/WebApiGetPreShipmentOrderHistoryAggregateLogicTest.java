...
public class WebApiGetPreShipmentOrderHistoryAggregateLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetPreShipmentOrderHistoryResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetPreShipmentOrderHistoryAggregateLogic.execute(requestDto);
