...
public class WebApiGetUserInformationLogicTest {
    @Autowired
    WebApiGetUserInformationLogic webApiGetUserInformationLogic;
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetUserInformationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetUserInformationLogic.execute(requestDto);
