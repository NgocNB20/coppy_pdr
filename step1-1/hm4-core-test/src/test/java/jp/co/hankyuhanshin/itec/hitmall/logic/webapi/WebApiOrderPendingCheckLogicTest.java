...
public class WebApiOrderPendingCheckLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiOrderPendingCheckResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiOrderPendingCheckLogic.execute(requestDto);
