...
public class WebApiGetPurchasedCommodityInformationLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetPurchasedCommodityInformationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetPurchasedCommodityInformationLogic.execute(requestDto);
