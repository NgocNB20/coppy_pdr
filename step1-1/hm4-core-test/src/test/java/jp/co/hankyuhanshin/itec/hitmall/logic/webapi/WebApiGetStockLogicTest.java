...
public class WebApiGetStockLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetStockResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetStockLogic.execute(requestDto);
