...
public class CartGoodsCheckServiceTest {

    @Autowired
    CartGoodsCheckService cartGoodsCheckService;
    ...
    public void executeTest() {
        ...
        goodsDetailsDto.setCatalogCode("");
        ...
        Map<Integer, List<CheckMessageDto>> errorMessageMap = cartGoodsCheckService.execute(cartDto);

        // CartGoodsCheckLogicのcheckOpenStatusでエラーが発生
