...
public class WebApiGetDiscountsResultLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetDiscountsResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetDiscountsResultLogic.execute(requestDto);
