...
public class CategoryListGetServiceTest {

    @Autowired
    CategoryListGetService service;

    @MockBean
    private CategoryListGetLogic logic;
    ...
    public void executeTest() {
        ...
        // 試験実行
        List<CategoryEntity> actual = service.execute(dto);
