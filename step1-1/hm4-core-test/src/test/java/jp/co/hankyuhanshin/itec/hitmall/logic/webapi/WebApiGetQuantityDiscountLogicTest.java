...
public class WebApiGetQuantityDiscountLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetQuantityDiscountResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetQuantityDiscountLogic.execute(requestDto);
