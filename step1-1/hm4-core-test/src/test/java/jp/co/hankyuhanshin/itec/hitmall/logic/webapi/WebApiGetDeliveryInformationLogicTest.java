...
public class WebApiGetDeliveryInformationLogicTest {
    @Autowired
    ...
    public void executeTest() throws IOException {
        ...
        AbstractWebApiResponseDto responseDto = new WebApiGetDeliveryInformationResponseDto();
        ...
        AbstractWebApiResponseDto result = webApiGetDeliveryInformationLogic.execute(requestDto);
