 ...
 */
@Component
public class SettlementMethodPriceCommissionRegistLogicImpl extends AbstractShopLogic
                implements SettlementMethodPriceCommissionRegistLogic {
    ...
    @Autowired
    public SettlementMethodPriceCommissionRegistLogicImpl(SettlementMethodPriceCommissionDao settlementMethodPriceCommissionDao) {
    ...
    public int execute(SettlementMethodPriceCommissionEntity settlementMethodPriceCommissionEntity) {
        ...
        settlementMethodPriceCommissionEntity.setRegistTime(currentTime);
        settlementMethodPriceCommissionEntity.setUpdateTime(currentTime);

        return settlementMethodPriceCommissionDao.insert(settlementMethodPriceCommissionEntity);
    }
