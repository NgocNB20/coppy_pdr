...
import jp.co.hankyuhanshin.itec.hitmall.dto.webapi.member.WebApiRepUserFaxResponseDto;
 ...
 */
@Component
public class WebApiRepUserFaxLogicImpl extends AbstractWebApiLogic implements WebApiRepUserFaxLogic {
     ...
     */
    @Autowired
    public WebApiRepUserFaxLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiRepUserFaxRequestDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiRepUserFaxResponseDto responseDto = ApplicationContextUtility.getBean(WebApiRepUserFaxResponseDto.class);
        responseDto = (WebApiRepUserFaxResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiRepUserFaxLogic.class);
    }
