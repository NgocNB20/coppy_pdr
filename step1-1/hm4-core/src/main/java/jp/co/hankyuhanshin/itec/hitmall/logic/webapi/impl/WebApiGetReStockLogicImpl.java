 ...
 */
@Component
public class WebApiGetReStockLogicImpl extends AbstractWebApiLogic implements WebApiGetReStockLogic {
     ...
     */
    @Autowired
    public WebApiGetReStockLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiGetReStockResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiGetReStockResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetReStockResponseDto.class);
        responseDto = (WebApiGetReStockResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetReStockLogic.class);
    }
