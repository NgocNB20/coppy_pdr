 ...
 */
public interface ConveniEntryExecTranLogic {
     ...
     */
    EntryExecTranCvsOutput execute(ReceiveOrderDto dto);
     ...
     */
    List<CheckMessageDto> checkCsvOutput(EntryExecTranCvsOutput output);
}
