 ...
 */
@Component
public class WebApiGetQuantityDiscountResultLogicImpl extends AbstractWebApiLogic
                implements WebApiGetQuantityDiscountResultLogic {
     ...
     */
    @Autowired
    public WebApiGetQuantityDiscountResultLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiGetQuantityDiscountResultResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiGetQuantityDiscountResultResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetQuantityDiscountResultResponseDto.class);
        responseDto = (WebApiGetQuantityDiscountResultResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetQuantityDiscountLogic.class);
    }
