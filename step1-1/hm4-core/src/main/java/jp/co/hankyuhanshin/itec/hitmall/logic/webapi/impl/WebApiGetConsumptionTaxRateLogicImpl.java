 ...
 */
@Component
public class WebApiGetConsumptionTaxRateLogicImpl extends AbstractWebApiLogic
                implements WebApiGetConsumptionTaxRateLogic {
     ...
     */
    @Autowired
    public WebApiGetConsumptionTaxRateLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiGetConsumptionTaxRateResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiGetConsumptionTaxRateResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetConsumptionTaxRateResponseDto.class);
        responseDto = (WebApiGetConsumptionTaxRateResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetConsumptionTaxRateLogic.class);
    }
