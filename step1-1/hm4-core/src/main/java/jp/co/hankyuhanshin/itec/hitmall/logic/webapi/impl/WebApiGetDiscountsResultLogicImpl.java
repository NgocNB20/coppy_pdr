 ...
 */
@Component
public class WebApiGetDiscountsResultLogicImpl extends AbstractWebApiLogic implements WebApiGetDiscountsResultLogic {
     ...
     */
    @Autowired
    public WebApiGetDiscountsResultLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
    ...
    public AbstractWebApiResponseDto createRes(String res) {
        ...
        WebApiGetDiscountsResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetDiscountsResponseDto.class);
        responseDto = (WebApiGetDiscountsResponseDto) jsonUtility.decode(res, responseDto);
