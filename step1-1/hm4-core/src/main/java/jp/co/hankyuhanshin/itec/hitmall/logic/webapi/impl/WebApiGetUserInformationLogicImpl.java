 ...
 */
@Component
public class WebApiGetUserInformationLogicImpl extends AbstractWebApiLogic implements WebApiGetUserInformationLogic {
     ...
     */
    @Autowired
    public WebApiGetUserInformationLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiGetUserInfomationResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiGetUserInformationResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetUserInformationResponseDto.class);
        responseDto = (WebApiGetUserInformationResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetUserInformationLogic.class);
    }
