...
import jp.co.hankyuhanshin.itec.hitmall.dto.webapi.member.WebApiDelDestinationResponseDto;
 ...
 */
@Component
public class WebApiDelDestinationLogicImpl extends AbstractWebApiLogic implements WebApiDelDestinationLogic {
     ...
     */
    @Autowired
    public WebApiDelDestinationLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
    ...
    public AbstractWebApiResponseDto execute(AbstractWebApiRequestDto requestDto) {
        ...
        if (StringUtils.isEmpty(res)) {
            ...
            throwMessage(MSGCD_ERR_DEL_DESTINATION, null);
        }
     ...
     * @return WEB-API連携取得結果クラス(WebApiDelDestinationResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiDelDestinationResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiDelDestinationResponseDto.class);
        responseDto = (WebApiDelDestinationResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiDelDestinationLogic.class);
    }
