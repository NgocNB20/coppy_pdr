 ...
 */
@Component
public class WebApiGetStockLogicImpl extends AbstractWebApiLogic implements WebApiGetStockLogic {
     ...
     */
    @Autowired
    public WebApiGetStockLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
    ...
    public AbstractWebApiResponseDto createRes(String res) {
        ...
        WebApiGetStockResponseDto responseDto = ApplicationContextUtility.getBean(WebApiGetStockResponseDto.class);
        responseDto = (WebApiGetStockResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetStockLogic.class);
    }
