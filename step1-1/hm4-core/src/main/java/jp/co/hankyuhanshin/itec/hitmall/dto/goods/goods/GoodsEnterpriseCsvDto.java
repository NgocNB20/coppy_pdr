...
import static jp.co.hankyuhanshin.itec.hmbase.constant.ValidatorConstants.REGEX_UL_CATEGORY_ID;
import static jp.co.hankyuhanshin.itec.hmbase.constant.ValidatorConstants.REGEX_UL_GOODS_CODE;
import static jp.co.hankyuhanshin.itec.hmbase.constant.ValidatorConstants.REGEX_UL_GOODS_GROUP_CODE;

/**
 * PDR#10 07_データ連携（商品情報）新規商品情報を含めた基幹連携新規商品CsvDtoクラス<br/>
 *
...
@Component
@Scope("prototype")
public class GoodsEnterpriseCsvDto implements Serializable {
