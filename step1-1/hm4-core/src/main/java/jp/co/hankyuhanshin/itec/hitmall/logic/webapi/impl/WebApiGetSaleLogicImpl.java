 ...
 */
@Component
public class WebApiGetSaleLogicImpl extends AbstractWebApiLogic implements WebApiGetSaleLogic {
     ...
     */
    @Autowired
    public WebApiGetSaleLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
    ...
    public AbstractWebApiResponseDto createRes(String res) {
        ...
        WebApiGetSaleResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetSaleResponseDto.class);
        responseDto = (WebApiGetSaleResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetSaleLogic.class);
    }
