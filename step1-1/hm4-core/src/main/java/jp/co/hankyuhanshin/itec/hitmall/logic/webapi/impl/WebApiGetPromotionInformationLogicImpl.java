 ...
 */
@Component
public class WebApiGetPromotionInformationLogicImpl extends AbstractWebApiLogic
                implements WebApiGetPromotionInformationLogic {
     ...
     */
    @Autowired
    public WebApiGetPromotionInformationLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
    ...
    public AbstractWebApiResponseDto execute(AbstractWebApiRequestDto requestDto) {
        ...
        // WEB-API 処理結果 エラー
        if (!WEB_API_STATUS_SUCCESS.equals(dto.getResult().getStatus()) && !WEB_API_STATUS_SUCCESS_EXCLUDED.equals(
     ...
     * @return WEB-API連携取得結果クラス(WebApiGetPromotionInformationResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiGetPromotionInformationResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetPromotionInformationResponseDto.class);
        responseDto = (WebApiGetPromotionInformationResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetPromotionInformationLogic.class);
    }
