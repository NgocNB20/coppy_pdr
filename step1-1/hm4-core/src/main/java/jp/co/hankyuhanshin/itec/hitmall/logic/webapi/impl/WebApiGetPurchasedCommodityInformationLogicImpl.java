 ...
 */
@Component
public class WebApiGetPurchasedCommodityInformationLogicImpl extends AbstractWebApiLogic
                implements WebApiGetPurchasedCommodityInformationLogic {
     ...
     */
    @Autowired
    public WebApiGetPurchasedCommodityInformationLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
    ...
    public AbstractWebApiResponseDto createRes(String res) {
        ...
        WebApiGetPurchasedCommodityInformationResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetPurchasedCommodityInformationResponseDto.class);
        responseDto = (WebApiGetPurchasedCommodityInformationResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetPurchasedCommodityInformationLogic.class);
    }
