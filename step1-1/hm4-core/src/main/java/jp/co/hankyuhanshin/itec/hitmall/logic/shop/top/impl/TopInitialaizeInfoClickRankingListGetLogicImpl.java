 ...
 */
@Component
public class TopInitialaizeInfoClickRankingListGetLogicImpl extends AbstractShopLogic
                implements TopInitialaizeInfoClickRankingListGetLogic {
    /**
     * 商品ランキングDao
     */
    ...
    @Autowired
    public TopInitialaizeInfoClickRankingListGetLogicImpl(GoodsRankingDao goodsRankingDao) {
    ...
    public List<GoodsRankingEntity> execute(Integer shopSeq) {
        return goodsRankingDao.getClickRanking(shopSeq);
    }
