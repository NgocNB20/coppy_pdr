 ...
 */
@Component
public class WebApiOrderPendingCheckLogicImpl extends AbstractWebApiLogic implements WebApiOrderPendingCheckLogic {
     ...
     */
    @Autowired
    public WebApiOrderPendingCheckLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiOrderPendingCheckResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiOrderPendingCheckResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiOrderPendingCheckResponseDto.class);
        responseDto = (WebApiOrderPendingCheckResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiOrderPendingCheckLogic.class);
    }
