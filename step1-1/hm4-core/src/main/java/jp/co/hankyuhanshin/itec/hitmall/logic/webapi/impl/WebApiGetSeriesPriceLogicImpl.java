 ...
 */
@Component
public class WebApiGetSeriesPriceLogicImpl extends AbstractWebApiLogic implements WebApiGetSeriesPriceLogic {
     ...
     */
    @Autowired
    public WebApiGetSeriesPriceLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiGetSeriesPriceResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiGetSeriesPriceResponseDto responseDto =
                        ApplicationContextUtility.getBean(WebApiGetSeriesPriceResponseDto.class);
        responseDto = (WebApiGetSeriesPriceResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiGetSeriesPriceLogic.class);
    }
