...
public class WebApiAddCouponLogicImpl extends AbstractWebApiLogic implements WebApiAddCouponLogic {
     ...
     */
    @Autowired
    public WebApiAddCouponLogicImpl(JsonUtility jsonUtility) {
        super(jsonUtility);
    }
     ...
     * @return WEB-API連携取得結果クラス(WebApiAddCouponResponseDto)
     */
    public AbstractWebApiResponseDto createRes(String res) {

        WebApiAddCouponResponseDto responseDto = ApplicationContextUtility.getBean(WebApiAddCouponResponseDto.class);
        responseDto = (WebApiAddCouponResponseDto) jsonUtility.decode(res, responseDto);
    ...
    protected Logger getLogger() {
        ...
        return LoggerFactory.getLogger(WebApiAddCouponLogic.class);
    }
