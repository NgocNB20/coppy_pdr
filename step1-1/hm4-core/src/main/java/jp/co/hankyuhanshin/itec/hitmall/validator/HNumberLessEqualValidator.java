 ...
 */
@Data
public class HNumberLessEqualValidator implements ConstraintValidator<HVRNumberLessEqual, Object> {
     ...
     */
    private BigDecimalConversionUtil bigDecimalConversionUtil;

    /**
     * アノテーションの情報設定
     */
    @Override
    public void initialize(HVRNumberLessEqual annotation) {
    ...
    public boolean isValid(Object value, ConstraintValidatorContext context) {
        ...
        if (numberUtility.isNumber(targetValue) && numberUtility.isNumber(comparisonValue)) {
            ...
            // 比較チェック
            if (!isLessThan(targetValue, comparisonValue)) {
     ...
     */
    protected boolean isLessThan(Object targetValue, Object comparisonValue) {
