...
ORDER BY
/*%if accessInfoSearchForDaoConditionDto.pageInfo.orderField == "campaignCode"*/
campaigncode
/*%if accessInfoSearchForDaoConditionDto.pageInfo.orderAsc == true */ ASC /*%else*/ DESC /*%end*/
/*%end*/

/*%if accessInfoSearchForDaoConditionDto.pageInfo.orderField == "campaignName"*/
campaignname
/*%if accessInfoSearchForDaoConditionDto.pageInfo.orderAsc == true */ ASC /*%else*/ DESC /*%end*/
/*%end*/

/*%if accessInfoSearchForDaoConditionDto.pageInfo.orderField == "note"*/
note
/*%if accessInfoSearchForDaoConditionDto.pageInfo.orderAsc == true */ ASC /*%else*/ DESC /*%end*/
/*%end*/
