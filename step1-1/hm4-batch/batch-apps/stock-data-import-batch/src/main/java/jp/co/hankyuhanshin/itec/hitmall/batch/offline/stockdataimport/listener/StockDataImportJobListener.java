 ...
 *
 */
package jp.co.hankyuhanshin.itec.hitmall.batch.offline.stockdataimport.listener;
...
@Component
public class StockDataImportJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(StockDataImportJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public StockDataImportJobListener(JobExplorer jobExplorer) {
