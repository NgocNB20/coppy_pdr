 ...
 *
 */
package jp.co.hankyuhanshin.itec.hitmall.batch.offline.cuenotefcsale.listener;
...
@Component
public class CuenoteFCSaleJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(CuenoteFCSaleJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public CuenoteFCSaleJobListener(JobExplorer jobExplorer) {
