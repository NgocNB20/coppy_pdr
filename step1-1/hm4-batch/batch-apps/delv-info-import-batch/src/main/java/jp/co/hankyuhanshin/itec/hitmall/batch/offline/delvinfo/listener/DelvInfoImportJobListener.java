package jp.co.hankyuhanshin.itec.hitmall.batch.offline.delvinfo.listener;
...
@Component
public class DelvInfoImportJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(DelvInfoImportJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public DelvInfoImportJobListener(JobExplorer jobExplorer) {
