...
@Component
public class GoodsAsyncJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(GoodsAsyncJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public GoodsAsyncJobListener(JobExplorer jobExplorer) {
