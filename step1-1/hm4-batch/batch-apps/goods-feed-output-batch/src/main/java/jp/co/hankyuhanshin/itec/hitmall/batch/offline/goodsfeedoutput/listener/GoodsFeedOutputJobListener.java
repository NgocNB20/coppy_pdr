 ...
 *
 */
package jp.co.hankyuhanshin.itec.hitmall.batch.offline.goodsfeedoutput.listener;
...
@Component
public class GoodsFeedOutputJobListener extends JobExecutionListenerSupport {
    private static final Logger log = LoggerFactory.getLogger(GoodsFeedOutputJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public GoodsFeedOutputJobListener(JobExplorer jobExplorer) {
