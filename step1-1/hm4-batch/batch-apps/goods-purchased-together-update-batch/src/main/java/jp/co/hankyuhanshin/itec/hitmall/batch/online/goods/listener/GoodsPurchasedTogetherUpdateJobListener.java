...
package jp.co.hankyuhanshin.itec.hitmall.batch.online.goods.listener;
...
@Component
public class GoodsPurchasedTogetherUpdateJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(GoodsPurchasedTogetherUpdateJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public GoodsPurchasedTogetherUpdateJobListener(JobExplorer jobExplorer) {
