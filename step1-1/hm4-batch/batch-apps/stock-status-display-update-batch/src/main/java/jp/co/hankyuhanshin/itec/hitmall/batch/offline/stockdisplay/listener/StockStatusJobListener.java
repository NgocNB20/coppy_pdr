package jp.co.hankyuhanshin.itec.hitmall.batch.offline.stockdisplay.listener;
...
@Component
public class StockStatusJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(StockStatusJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public StockStatusJobListener(JobExplorer jobExplorer) {
