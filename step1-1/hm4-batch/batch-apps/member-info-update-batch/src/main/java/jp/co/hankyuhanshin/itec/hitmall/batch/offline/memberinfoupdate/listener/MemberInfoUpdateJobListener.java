package jp.co.hankyuhanshin.itec.hitmall.batch.offline.memberinfoupdate.listener;
...
@Component
public class MemberInfoUpdateJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(MemberInfoUpdateJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public MemberInfoUpdateJobListener(JobExplorer jobExplorer) {
