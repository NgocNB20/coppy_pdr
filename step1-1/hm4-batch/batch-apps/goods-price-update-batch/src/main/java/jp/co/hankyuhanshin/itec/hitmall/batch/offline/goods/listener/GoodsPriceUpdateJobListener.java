...
package jp.co.hankyuhanshin.itec.hitmall.batch.offline.goods.listener;
...
@Component
public class GoodsPriceUpdateJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(GoodsPriceUpdateJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public GoodsPriceUpdateJobListener(JobExplorer jobExplorer) {
