package jp.co.hankyuhanshin.itec.hitmall.batch.offline.shop.top.listener;
...
@Component
public class TopTotalingJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(TopTotalingJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public TopTotalingJobListener(JobExplorer jobExplorer) {
