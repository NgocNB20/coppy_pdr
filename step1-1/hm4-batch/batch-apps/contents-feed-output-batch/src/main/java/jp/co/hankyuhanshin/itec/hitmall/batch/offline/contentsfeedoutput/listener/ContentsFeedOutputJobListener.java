package jp.co.hankyuhanshin.itec.hitmall.batch.offline.contentsfeedoutput.listener;
...
@Component
public class ContentsFeedOutputJobListener extends JobExecutionListenerSupport {
    private static final Logger log = LoggerFactory.getLogger(ContentsFeedOutputJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public ContentsFeedOutputJobListener(JobExplorer jobExplorer) {
