...
package jp.co.hankyuhanshin.itec.hitmall.batch.online.digitalcatalog.listener;
...
@Component
public class DigitalCatalogImportJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(DigitalCatalogImportJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public DigitalCatalogImportJobListener(JobExplorer jobExplorer) {
