package jp.co.hankyuhanshin.itec.hitmall.batch.online.mail.listener;
...
@Component
public class MailJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(MailJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public MailJobListener(JobExplorer jobExplorer) {
