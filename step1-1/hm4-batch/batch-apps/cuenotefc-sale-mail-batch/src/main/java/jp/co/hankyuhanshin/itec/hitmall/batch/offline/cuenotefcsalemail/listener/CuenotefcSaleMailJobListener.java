 ...
 *
 */
package jp.co.hankyuhanshin.itec.hitmall.batch.offline.cuenotefcsalemail.listener;
...
@Component
public class CuenotefcSaleMailJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(CuenotefcSaleMailJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public CuenotefcSaleMailJobListener(JobExplorer jobExplorer) {
