package jp.co.hankyuhanshin.itec.hitmall.batch.offline.shop.sitemap.listener;
...
@Component
public class SiteMapJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(SiteMapJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public SiteMapJobListener(JobExplorer jobExplorer) {
