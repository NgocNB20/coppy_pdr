 ...
 *
 */
package jp.co.hankyuhanshin.itec.hitmall.batch.offline.cuenotefcsalemailconfirm.listener;
...
@Component
public class CuenotefcSaleMailConfirmJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(CuenotefcSaleMailConfirmJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public CuenotefcSaleMailConfirmJobListener(JobExplorer jobExplorer) {
