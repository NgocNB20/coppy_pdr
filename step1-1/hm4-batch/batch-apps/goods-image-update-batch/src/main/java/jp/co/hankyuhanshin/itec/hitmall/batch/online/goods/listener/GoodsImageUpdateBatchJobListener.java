...
@Component
public class GoodsImageUpdateBatchJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(GoodsImageUpdateBatchJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public GoodsImageUpdateBatchJobListener(JobExplorer jobExplorer) {
