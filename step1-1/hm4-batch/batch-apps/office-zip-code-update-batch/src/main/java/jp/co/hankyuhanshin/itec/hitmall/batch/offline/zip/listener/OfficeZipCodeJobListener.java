...
@Component
public class OfficeZipCodeJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(OfficeZipCodeJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public OfficeZipCodeJobListener(JobExplorer jobExplorer) {
