package jp.co.hankyuhanshin.itec.hitmall.batch.online.order.listener;
...
@Component
public class OrderCsvAsyncJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(OrderCsvAsyncJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public OrderCsvAsyncJobListener(JobExplorer jobExplorer) {
