package jp.co.hankyuhanshin.itec.hitmall.batch.offline.zip.listener;
...
@Component
public class ZipCodeUpdateJobListener extends JobExecutionListenerSupport {

    private static final Logger log = LoggerFactory.getLogger(ZipCodeUpdateJobListener.class);
    private final JobExplorer jobExplorer;

    @Autowired
    public ZipCodeUpdateJobListener(JobExplorer jobExplorer) {
