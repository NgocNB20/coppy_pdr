...
/**
 * PDR#15 WEB-API連携 注文履歴（配送済み）取得APIのレスポンスモデル<br/>
 *
 * @author k-katoh
 */
public class GetPreShipmentOrderHistoryResponse {
    ...
    /** 商品リスト */
    private List<GetPreShipmentOrderHistoryGoodsResponse> goodsList;
     ...
     */
    public List<GetPreShipmentOrderHistoryGoodsResponse> getGoodsList() {
        return goodsList;
    }
     ...
     */
    public void setGoodsList(List<GetPreShipmentOrderHistoryGoodsResponse> goodsList) {
