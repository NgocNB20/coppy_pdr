...
/**
 * PDR#15 WEB-API連携 会員情報登録のリクエストモデル<br/>
 *
 * @author k-katoh
 */
public class AddUserInformationRequest {
    ...
    /**
     * @return the shinryoMemo
     */
    public String getShinryoMemo() {
        return shinryoMemo;
    }

    /**
     * @param shinryoMemo the shinryoMemo to set
     */
    public void setShinryoMemo(String shinryoMemo) {
        this.shinryoMemo = shinryoMemo;
    }
